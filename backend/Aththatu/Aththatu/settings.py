"""
Django settings for Aththatu project.
...
SECRET_KEY = 'django-insecure-uh3yh4k-nhjobqlr#6(z_d90jou_1mz7a-17$@%af0-4*si_36'
...
WSGI_APPLICATION = 'Aththatu.wsgi.application'
